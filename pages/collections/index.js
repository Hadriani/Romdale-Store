...
import COLLECTIONS_MAP from '../../collections.data';
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.collectionscaffolding}>
              {COLLECTIONS_MAP.map(({ id, name, className, button, route, image }) => (
                <div key={id} className={className} style={{ backgroundImage: `url(${image})` }}>
                    <p className={styles.namecontainers}>{name}</p>
                    <Link href="/collections/[category]" as={`/collections/${route}`}>
            ...
            <div className={styles.wrapperfooter2}>

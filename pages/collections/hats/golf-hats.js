...
function GolfHatPage(props) {
    ...
    const GOLFHat_MAP = HATS_MAP.filter(item => item.category === 'Golf Hats');
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.searchhatcontainer2}>
                <h1 className={styles.headercaps}>GOLF HATS</h1>
            ...
            <div className={styles.hatscaffoldingcontainer}>
                {GOLFHat_MAP.map(({ id, name, imageUrl, price, cartButton, favoriteButton }) => (

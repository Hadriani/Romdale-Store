...
function CapsPage(props) {
    ...
    const CAPS_MAP = HATS_MAP.filter(item => item.category === 'Caps');
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.searchhatcontainer2}>
                <h1 className={styles.headercaps}>CAPS</h1>
            ...
            <div className={styles.hatscaffoldingcontainer}>
                {CAPS_MAP.map(({ id, name, imageUrl, price, cartButton, favoriteButton }) => (

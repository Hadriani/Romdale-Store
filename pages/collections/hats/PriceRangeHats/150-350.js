...
function TwoHundredFiftyPage(props) {
    ...
    const RANGE_MAP = sortedItems.filter(item => item.priceRange === '150-350').slice(currentPage * 8, (currentPage + 1) * 8);
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.searchhatcontainer2}>
                <h1 className={styles.headercaps}></h1>
                ...
                <div className={styles.pricesidecontainer}>
                    ...
                    <div className={styles.selectPrice}>
                        <select className={styles.selectbar} onChange={handleSelectChange2} onClick={toggleArrow2}>
                            ...
                            <option value="50-150">100$ - 150$</option>
            ...
            <div className={styles.hatscaffoldingcontainer}>
                {RANGE_MAP.map(({ id, name, imageUrl, price, cartButton, favoriteButton }) => (
            ...
            <div className={styles.wrapperfooter6}>
...
export default TwoHundredFiftyPage;
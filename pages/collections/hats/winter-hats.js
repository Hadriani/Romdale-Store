...
function WinterHatPage(props) {
    ...
    const WinterHat_MAP = HATS_MAP.filter(item => item.category === 'Winter Hats');
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.searchhatcontainer2}>
                <h1 className={styles.headercaps}>WINTER HATS</h1>
            ...
            <div className={styles.hatscaffoldingcontainer}>
                {WinterHat_MAP.map(({ id, name, imageUrl, price, cartButton, favoriteButton }) => (

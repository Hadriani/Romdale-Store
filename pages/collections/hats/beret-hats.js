...
function BeretHatPage(props) {
    ...
    const BeretHat_MAP = HATS_MAP.filter(item => item.category === 'Beret Hats');
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.searchhatcontainer2}>
                <h1 className={styles.headercaps}>BERET HATS</h1>
            ...
            <div className={styles.hatscaffoldingcontainer}>
                {BeretHat_MAP.map(({ id, name, imageUrl, price, cartButton, favoriteButton }) => (

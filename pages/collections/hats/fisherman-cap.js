...
function FishermanPage(props) {
    ...
    const Fisherman_MAP = HATS_MAP.filter(item => item.category === 'Fisherman Cap');
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.searchhatcontainer2}>
                <h1 className={styles.headercaps}>FISHERMAN CAP</h1>
            ...
            <div className={styles.hatscaffoldingcontainer}>
                {Fisherman_MAP.map(({ id, name, imageUrl, price, cartButton, favoriteButton }) => (

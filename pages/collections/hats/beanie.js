...
function BeaniePage(props) {
    ...
    const BEANIE_MAP = HATS_MAP.filter(item => item.category === 'Beanie');
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.searchhatcontainer2}>
                <h1 className={styles.headercaps}>BEANIE</h1>
            ...
            <div className={styles.hatscaffoldingcontainer}>
                {BEANIE_MAP.map(({ id, name, imageUrl, price, cartButton, favoriteButton }) => (
            ...
            <div className={styles.wrapperfooter4}>

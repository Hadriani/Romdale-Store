...
function NikeBootsPage(props) {
    ...
    const NIKEBOOTS_MAP = SHOES_MAP.filter(item => item.category === 'C&J Nike Boots');
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.searchhatcontainer2}>
                <h1 className={styles.headercaps}>C&J NIKE BOOTS</h1>
            ...
            <div className={styles.hatscaffoldingcontainer}>
                {NIKEBOOTS_MAP.map(({ id, name, imageUrl, price, cartButton, favoriteButton }) => (
                ...
                <div className={styles.blankhatcontainer5}></div>
            </div>

            <div className={styles.wrapperfooter8}>

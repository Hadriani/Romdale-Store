...
import SortMainShoes from "../../../components/Layout/sortby-mainshoes";
...
function Shoes() {
    ...
    const [arrowDirection3, setArrowDirection3] = useState("up")
    ...
    function toggleArrow3() {
        if (arrowDirection3 === 'up') {
            setArrowDirection3("down")
        } else {
            setArrowDirection3("up")
        }
    }
    ...
    const shoesToDisplay = sortedItems.slice(currentPage * 8, (currentPage + 1) * 8);
        ...
        <CartProvider>
            <div>
                ...
                <div className={styles.searchhatcontainer2}>
                    <h1 className={styles.headertoolbar}>FOOTWEAR</h1>
                ...
                <div className={styles.sidebar}>
                    ...
                    <div className={styles.pricesidecontainer}>
                        ...
                        <div className={styles.selectPrice}>
                            <select className={styles.selectbar} onClick={toggleArrow2}>
                                <option value="all">All</option>
                    ...
                    <div className={styles.pricesidecontainer}>
                        <h2>Best For</h2>
                        <div className={styles.selectPrice}>
                            <select className={styles.selectbar} onClick={toggleArrow3}>
                                <option value="all">All</option>
                                <option value="ColdWeather">Cold Weather</option>
                                <option value="DryWeather">Dry Weather</option>
                                <option value="WetWeather">Wet Weather</option>
                            </select>
                            {arrowDirection3 === 'up' ? <SlArrowUp className={styles.arrow} /> : <SlArrowDown className={styles.arrow} />}
                        </div>
                    </div>
                </div>
                ...
                <div className={styles.hatscaffoldingcontainer}>
                    {shoesToDisplay.map(({ id, name, imageUrl, price, cartButton, favoriteButton }) => (
                        <div key={id} className={styles.hatitemcontainer}
                            ...
                            <div style={{ textAlign: 'center' }}>
                                <Link href="/collections/shoes/[id]" as={`/collections/shoes/${id}`}>

...
function NikeAirMaxPage(props) {
    ...
    const NIKEAIRMAX_MAP = sortedItems.filter(item => item.category === 'Nike Air Max').slice(currentPage * 5, (currentPage + 1) * 5);
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.searchhatcontainer2}>
                <h1 className={styles.headercaps}>NIKE AIR MAX</h1>
            ...
            <div className={styles.hatscaffoldingcontainer}>
                {NIKEAIRMAX_MAP.map(({ id, name, imageUrl, price, cartButton, favoriteButton }) => (
            ...
            <div className={styles.blankhatcontainer6}>

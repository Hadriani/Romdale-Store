...
function AnnaFieldPage(props) {
    ...
    const ANNA_MAP = SHOES_MAP.filter(item => item.category === 'Anna Field');
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.searchhatcontainer2}>
                <h1 className={styles.headercaps}>ANNA FIELD</h1>
            ...
            <div className={styles.hatscaffoldingcontainer}>
                {ANNA_MAP.map(({ id, name, imageUrl, price, cartButton, favoriteButton }) => (
            ...
            <div className={styles.wrapperfooter7}>

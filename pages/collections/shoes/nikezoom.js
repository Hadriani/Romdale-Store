...
function NikeZoomPage(props) {
    ...
    const NIKEZOOM_MAP = SHOES_MAP.filter(item => item.category === 'Nike Zoom');
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.searchhatcontainer2}>
                <h1 className={styles.headercaps}>NIKE ZOOM</h1>
            ...
            <div className={styles.hatscaffoldingcontainer}>
                {NIKEZOOM_MAP.map(({ id, name, imageUrl, price, cartButton, favoriteButton }) => (

...
function TwentyHundredPage(props) {
    ...
    const RANGE_MAP = sortedItems.filter(item => item.priceRange === '20-100').slice(currentPage * 8, (currentPage + 1) * 8);
...
export default TwentyHundredPage;
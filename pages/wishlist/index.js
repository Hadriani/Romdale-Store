...
import WishItem from '../../components/Layout/wishlist-component';
...
function WishList() {
    ...
    useEffect(() => {
        if (wishlistItems.length > 0) {
            const total = calculateOrderTotal(wishCount, 5);
            setOrderTotal(total);
        } else {
            setOrderTotal(0);
        }
            ...
            <div className={styles.checkoutcontainer2}>
                <div className={styles.checkoutheader}>
                    <div className={styles.headerblock2}>
                        <span className={styles.productcheck2}>Product</span>
                    </div>
                    <div className={styles.headerblock2}>
                        <span className={styles.descrcheck2}>Description</span>
                    </div>
                    <div className={styles.headerblock2}>
                        <span className={styles.pricecheck2}>Price</span>
                    </div>
                    <div className={styles.headerblock2}>
                        <span className={styles.transfer}>Transfer</span>
                    </div>
                    <div className={styles.headerblock2}>
                        <span className={styles.removecheck2}>Remove</span>
                    </div>
                </div>
                ...
                <div className={styles.itemcheckout}>
                    ...
                    {wishlistItems.length === 0 &&
                        <div className={styles.message}>
                            <p>No product is added to your wishlist</p>
                        </div>}
                    {wishlistItems.length > 0 &&

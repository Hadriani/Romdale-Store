...
import styles from '../../../branded-products/styles/Home.module.css';
                            ...
                            <ul>
                                ...
                                <li>
                                    <Link className={styles.a} href="/checkout">
                                        <svg className={`${styles.navicon} icon icon-tabler icon-tabler-cart`} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
